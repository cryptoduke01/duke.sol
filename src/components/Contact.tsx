...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-32 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[#00FFD1]/5 rounded-full blur-[200px]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-7xl font-semibold text-white mb-6 font-[family-name:var(--font-display)] lowercase">
            let&apos;s build
            <br />
            <span className="text-[#00FFD1]">together</span>
          </h2>

          <p className="text-[#666] max-w-md mx-auto mb-12 font-[family-name:var(--font-mono)] text-sm lowercase">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="group inline-flex items-center gap-4 px-8 py-4 glass border border-[#1a1a1a] hover:border-[#00FFD1]/50 transition-all duration-300"
          >
            <span className="text-lg sm:text-xl text-white font-[family-name:var(--font-mono)] group-hover:text-[#00FFD1] transition-colors lowercase">
              {email}
            </span>
            {copied ? (
              <Check size={20} className="text-[#00FFD1]" />
            ) : (
              <Copy size={20} className="text-[#666] group-hover:text-[#00FFD1] transition-colors" />
            )}
          </motion.button>
          ...
          {copied && (
            <motion.p
              ...
              className="text-[#00FFD1] text-xs mt-4 font-[family-name:var(--font-mono)] lowercase"
            >
              copied to clipboard
            </motion.p>
          )}
        ...
        >
          {socials.map((social, i) => (
            <motion.a
              ...
              whileHover={{ scale: 1.02 }}
              className="group flex items-center gap-3 px-6 py-3 glass border border-[#1a1a1a] hover:border-[#00FFD1]/50 transition-all duration-300"
            >
              <span className="text-xs text-[#666] font-[family-name:var(--font-mono)] lowercase">
                {social.name}
              </span>
              <span className="text-white font-[family-name:var(--font-mono)] group-hover:text-[#00FFD1] transition-colors lowercase">
                {social.handle}
              </span>
              <ArrowUpRight size={14} className="text-[#666] group-hover:text-[#00FFD1] transition-colors" />
            </motion.a>
          ))}
        </motion.div>
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 pt-16 border-t border-[#1a1a1a]"
        >
          {/* Logo column */}
          <div>
            ...
            <p className="text-xs text-[#666] font-[family-name:var(--font-mono)] leading-relaxed lowercase">
          ...
          {footerLinks.map((column) => (
            <div key={column.title}>
              <h4 className="text-xs text-[#666] font-[family-name:var(--font-mono)] tracking-[0.2em] mb-4 lowercase">
                {column.title}
              </h4>
                    ...
                    return (
                      <li key={link.name}>
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-sm text-[#999] hover:text-[#00FFD1] transition-colors font-[family-name:var(--font-mono)] lowercase link-line"
                        >
                          {link.name}
                        </a>
                      </li>
